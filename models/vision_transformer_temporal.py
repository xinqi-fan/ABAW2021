...
class TemporalVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_patches=9, num_classes=1000, embed_dim=768, depth=12,
...
@torch.no_grad()
def _load_weights(model: TemporalVisionTransformer, checkpoint_path: str, prefix: str = ''):
