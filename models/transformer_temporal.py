...
from .layers import PatchEmbed, PatchEmbedSeq, PatchEmbedSeqResNet, Mlp, DropPath, trunc_normal_, lecun_normal_
...
class TemporalTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_patches=9, num_classes=1000, embed_dim=768, depth=2,
                 num_heads=12, mlp_ratio=4., qkv_bias=True, representation_size=None, distilled=False,
                 drop_rate=0., attn_drop_rate=0., drop_path_rate=0., embed_layer=PatchEmbedSeqResNet, norm_layer=None,
        ...
        #     backbone=resnet50, patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim)
        # num_patches = self.patch_embed.num_patches

        self.pos_embed = PositionalEncoding(self.embed_dim, 0.5)
...
@torch.no_grad()
def _load_weights(model: TemporalTransformer, checkpoint_path: str, prefix: str = ''):
...
def _create_vision_transformer(variant, pretrained=False, default_cfg=None, **kwargs):
    ...
    model = build_model_with_cfg(
        TemporalVisionTransformer, variant, pretrained,
